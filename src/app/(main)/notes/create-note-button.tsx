...
export default function CreateNoteButton() {
  ...
  return (
    <>
      <Button onClick={() => setDialogOpen(true)} className="cursor-pointer items-center justify-center">
        <Plus />
        Create
      </Button>
      <CreateNoteDialog dialogOpen={dialogOpen} onDialogOpenChange={setDialogOpen}/>
    </>
  )
}

function CreateNoteDialog({ dialogOpen, onDialogOpenChange}: CreateNoteDialogProps) {
